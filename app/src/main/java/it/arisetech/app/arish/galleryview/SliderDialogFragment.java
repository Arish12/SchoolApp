...
public class SliderDialogFragment extends DialogFragment {
    private String TAG = SliderDialogFragment.class.getSimpleName();
    private ArrayList<GalleyImage> images;
...
FragmentTransaction fg;
  ...
  public static SliderDialogFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        images = (ArrayList<GalleyImage>) getArguments().getSerializable("images");
    ...
    private void displayMetaInfo(int position) {
        ...
        GalleyImage image = images.get(position);
